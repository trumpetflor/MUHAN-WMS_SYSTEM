                            ...
                            <div class="card-body card-block">
                                <form action="ClientInsertPro" method="post" class="form-horizontal">
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="business_no" name="business_no" placeholder="ex) 0123456789" class="form-control"><small class="form-text text-muted">'-' 를 제외한 숫자만 입력</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="cust_name" class=" form-control-label">상호 (거래처명)<font style="color: red;">*</font></label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="cust_name" name="cust_name" placeholder="ex) 댕댕잇" class="form-control"><small class="form-text text-muted"></small></div>
                                    </div>
                                    <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="boss_name" name="boss_name" placeholder="ex) 김댕댕" class="form-control"><small class="form-text text-muted"></small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="uptae" class=" form-control-label">업태<font style="color: red;">*</font></label></div>
                                        <div class="col col-md-9">
                                            <select name="uptae" id="uptae" data-placeholder="복수 선택 가능" multiple class="standardSelect">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                        	<div id="jongmokArea">
                                        	<input type="text" id="jongmok" name="jongmok" placeholder="ex) 동물용 사료 및 조제식품 제조업" class="form-control">
                                        	</div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                        	<input type="tel" id="tel" name="tel" placeholder="" class="form-control">
                                    ...
                                    <div class="row form-group">
										...
										<div class="col-12 col-md-4 d-flex">
											<input type="text" id="post_no" name="post_no" placeholder="ex) 00000"
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="man_name" name="man_name" placeholder="ex) 김무한" class="form-control"><small class="form-text text-muted"></small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="man_tel" class=" form-control-label">담당자 전화번호<font style="color: red;">*</font></label></div>
                                        <div class="col-12 col-md-9">
                                        	<input type="tel" id="man_tel" name="man_tel" placeholder="" class="form-control">
                                        	<small class="form-text text-muted">'-' 를 제외한 숫자만 입력</small>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><textarea name="remarks" id="remarks" rows="9" placeholder="Content..." class="form-control"></textarea></div>
                                    </div>
