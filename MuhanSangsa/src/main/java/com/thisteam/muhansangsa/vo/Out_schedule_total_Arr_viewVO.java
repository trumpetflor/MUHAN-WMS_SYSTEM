...
public class Out_schedule_total_Arr_viewVO {

//  출고 처리 목록 (세부 항목 표시) - 배열처리
...
//	REMARKS         |varchar(2000)	
	...
	public String toString() {
		return "Out_schedule_total_Arr_viewVO [out_schedule_cd=" + Arrays.toString(out_schedule_cd) + ", out_cd_1="
				+ Arrays.toString(out_cd_1) + ", out_cd_2=" + Arrays.toString(out_cd_2) + ", cust_name="
				+ Arrays.toString(cust_name) + ", emp_name=" + Arrays.toString(emp_name) + ", product_name="
				+ Arrays.toString(product_name) + ", out_date=" + Arrays.toString(out_date) + ", out_schedule_qty="
				+ Arrays.toString(out_schedule_qty) + ", out_qty=" + Arrays.toString(out_qty) + ", product_cd="
				+ Arrays.toString(product_cd) + ", stock_cd=" + Arrays.toString(stock_cd) + ", remarks="
